...
The hash that it returns is `QmTtokcWqLmGrSEN6f1srpX42n1HdmmmnjznB62RqB9r8Y`. So what is this hash? It has to be a JSON file like described before. I don't know what it looks like (yet).
